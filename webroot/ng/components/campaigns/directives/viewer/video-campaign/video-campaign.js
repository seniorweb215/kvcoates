'use strict';
content.directive('videoCampaignViewer', ["$rootScope", "$state", "appService", "digitalMediaAPI", function ($rootScope, $state, appService, digitalMediaAPI) {
        return {
            templateUrl: 'ng/components/campaigns/directives/viewer/video-campaign/view.html',
            scope: {
                contents: '='
            },
